...
from graph import Graph, StructureDataset
...
def load_graphs(
    ...
    cachedir: Optional[Path] = Path("data_cache"),
    ...
    if cachedir is not None:
        cachefile = cachedir / f"{tmp_name}-{neighbor_strategy}.bin"
    else:
        cachefile = None
    ...
    if cachefile is not None and cachefile.is_file():
        ...
        if cachefile is not None:
            ...
            dgl.save_graphs(str(cachefile), graphs)
